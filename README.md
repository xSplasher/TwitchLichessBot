...
4. We need to tell the bot which channel it should join. to do that:
   ...
   - can be many channels and the bot will join all of them and gather moves from them
...
if everything works fine, you'll see ```Bot is Connected``` in your chat, if you just created the lichess account, you'll probably get a token error, in that case just give it some time.
